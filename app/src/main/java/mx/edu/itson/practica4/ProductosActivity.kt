    ...
    fun agregarProductos(option:String?){
        when(option){
            ...
            "Especialidades"->{
                ...
                menu.add(Product("Coctel Camaron",R.drawable.coctel, "Delicioso coctel de camaron 250g",14.50))
                menu.add(Product("Botana Camarones",R.drawable.botanacamarones, "Deliciosa botana de camarones 350g", 17.99))
                menu.add(Product("Fajita Burrito",R.drawable.burritosportales, "Gran burrito relleno de tu carne favorita, cebolla, chile, arroz, frijoles y jitomate. Servido con lechuga y guacamole Large burrito filled with your choice of meat, onions, chile, peppers, rice, beans and tomatoes. Served with lettuce guacamole and sour cream.", 12.99))
            }
            "Sopas"->{
                menu.add(Product("Larger",R.drawable.sopas, "Deliciosa sopa tamaño grande",11.99))
                menu.add(Product("Camaron",R.drawable.sopas, "Deliciosa sopa tamaño grande con camaron",12.99))
                menu.add(Product("Pozole",R.drawable.pozole, "Weekens Only",5.99))
                menu.add(Product("Menudo",R.drawable.menudo, "Wednesday to Sunday",5.99))
                menu.add(Product("Caldo de Res",R.drawable.caldores, "Delicioso caldo de res",5.99))
            ...
            "Drinks"->{
                menu.add(Product("Sodas 20oZ",R.drawable.sodas, "Refrescante soda de distintos sabores",2.99))
                menu.add(Product("Jarritos",R.drawable.jarritos, "Refrescante jarrito",2.35))
                menu.add(Product("Domestic Beer",R.drawable.domesticbeer, "Refrescante cerveza",3.55))
                menu.add(Product("Mexican Beer",R.drawable.mexicanbeer, "Refrescante cerveza mexicana",3.99))
                menu.add(Product("Micheladas",R.drawable.michelada, "Refrescante michelada directo al paladar",6.75))
                menu.add(Product("Caguama",R.drawable.caguama, "Refrescante caguama",8.99))
                menu.add(Product("Caguama Michelada",R.drawable.caguamamichelada, "Refrescante caguama michelada",10.99))
                menu.add(Product("Cubetazos",R.drawable.cubetazo, "Refrescante cubetazo",21.99))
                menu.add(Product("Charolazo",R.drawable.charolazo, "Refrescante charolazo",15.75))
                menu.add(Product("Cubetazo (6 cervezas)",R.drawable.cubetasix, "Refrescante cubetazo sixpack",21.99))
            }
            "Tortas"->{
                ...
                menu.add(Product("Torta Cubana",R.drawable.tortacubana, "Chorizo, asada, jamon, pastor y queso Mexican sausage, steak, marinated pork, ham, and cheese",113.59))
            ...
            "Combinaciones"->{
                ...
                menu.add(Product("Dos Amigos",R.drawable.dosamigos, "Two hard shell tacos with your choice of meat topped with lettuce and shredded cheese. served with a side of rice and beans",18.99))
